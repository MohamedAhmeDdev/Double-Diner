        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="p-8 text-center bg-white border-b border-gray-100">
            <div className="flex justify-center mb-3">
              <div className="p-2.5 bg-gray-900 rounded-lg text-white">
          ...
          <form className="p-8 space-y-5" onSubmit={resetPassword}>
            ...
            <button
              type="submit"
              className='w-full !mt-6 flex items-center justify-center py-2.5 px-4 rounded-lg shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-all  bg-gray-900 hover:bg-black text-white'>
              {isLoading ? (
                <>
