  ...
  <div className="flex items-center justify-between  w-[48rem]">
    <div className="flex items-center space-x-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-gray-600 text-sm truncate  max-w-sm">
          {item?.description}
        </p>
      </div>
    </div>
        ...
        {cartItems?.length > 0 ? (
          <>
            <p className="text-xl font-bold text-gray-900">
              ...
              , with email{" "}
              <span className="text-2xl font-bold text-blue-600 lowercase">
                {user?.email}
              </span>{" "}
      ...
      <div className="block p-6 rounded-lg shadow-lg bg-white max-w-md">
        ...
        <form className="mt-4" onSubmit={placeOrder}>
          <div className="form-group mb-6 p-2">
            <label htmlFor="delivery_phone" className="text-gray-700">
              Phone Number
            </label>
          ...
          <div className="form-group mb-6 p-2">
            <label htmlFor="delivery_address" className="text-gray-700">
              Address
            </label>
